...
public class InvoiceView implements BaseView {
    ...
    private void loadData() {
        List<Invoice> invoices = invoiceController.getAllInvoice();
    ...
    private VBox createFormView() {
        ...
        form.add(gudangLabel, 0, 2);
        form.add(gudangSpinner, 1, 2);
        ...
        saveButton.setOnAction(e -> {
            ...
            try {
                ...
                int idGudang = gudangSpinner.getValue();
    ...
    private void showFormView(Invoice invoice) {
        ...
        Spinner<Integer> gudangSpinner = (Spinner<Integer>) form.getChildren().get(5);
        TextField unitPriceField = (TextField) form.getChildren().get(7);
        Spinner<Integer> qtySpinner = (Spinner<Integer>) form.getChildren().get(9);

        if (invoice == null) {
            formTitle.setText("Add New Invoice");
            titleField.clear();
            dateField.clear();
            gudangSpinner.getValueFactory().setValue(0);
            ...
            gudangSpinner.getValueFactory().setValue(invoice.getIdGudang());
